...
from ..probability.probabilistic_learning import CountingProbDist
from ..shared.utils import hashabledict
...
class UnixConsultant(IRSystem):
    ...
    def __init__(self):
        ...
        import os
        # data/ is at the repo root — two levels up from src/nlp/
        aima_root = os.path.dirname(os.path.dirname(os.path.dirname(__file__)))
        mandir = os.path.join(aima_root, 'data', 'MAN') + os.sep
